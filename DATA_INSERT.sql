...
(220, 'TC', 'ISLANDS', 'Turks and Caicos Islands', 'TCA', 796, 1649),
...
INSERT INTO `erp`.`user_permissions` (`user_id`, `username`, `display_name`, `active_directory`, `email`, `password`, `salt`, `origin`) VALUES (1, 'admin', 'Administrator', '724c0ab7-d833-43d1-aab5-f1b929cf7f02', 'administration@tablebricks.com', 'AQAAAAIAAYagAAAAEB6yaRw/UVuk5oZn2NoPjcalnpf', 'BnZU8ytIYd', 'local');
# 1 records
